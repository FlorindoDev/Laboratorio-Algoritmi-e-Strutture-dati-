...
public:
  ...
  bool operator==(const Iterator &) const = delete; // Comparison of abstract types is not possible.
  bool operator!=(const Iterator &) const = delete; // Comparison of abstract types is not possible.
...
public:
  ...
  // Move assignment
  MutableIterator & operator=(MutableIterator &&) = delete; // Move assignment of abstract types is not possible.

  /* ************************************************************************ */

  // Comparison operators
  bool operator==(const MutableIterator &) const = delete; // Comparison of abstract types is not possible.
  bool operator!=(const MutableIterator &) const = delete; // Comparison of abstract types is not possible.
...
public:
  ...
  // Comparison operators
  bool operator==(const ForwardIterator &) const = delete; // Comparison of abstract types is not possible.
  bool operator!=(const ForwardIterator &) const = delete; // Comparison of abstract types is not possible.
...
public:
  ...
  // Comparison operators
  bool operator==(const ResettableIterator &) const = delete; // Comparison of abstract types is not possible.
  bool operator!=(const ResettableIterator &) const = delete; // Comparison of abstract types is not possible.
